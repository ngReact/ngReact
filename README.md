...
- `prevent-events` attribute that take an array and prevent all events passed in parameter. these react's events will not bubble up in the angular application
